...
test systemDefaults_DetermineSysDefaults {
  ...
  ::tweircp::setOptions {}
} -result {silent 0 clean 1 syntax {} target {} empty_error 0 syntax_on_empty 0 unknown_error 1 usage {--- %bind% Options ---------------}}
...
} -result {silent 1 clean 0 syntax {command opt1 --switch -opt=what} target #somechannel empty_error 1 syntax_on_empty 1 unknown_error 0 usage {--- %command% Help Options ---------------}}
